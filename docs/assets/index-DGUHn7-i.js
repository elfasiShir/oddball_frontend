...
function requireReactDomClient_production() {
  ...
  function updateReducerImpl(hook, current, reducer) {
    ...
    if (null === baseQueue) hook.memoizedState = pendingQueue;
      ...
      var newBaseQueueFirst = baseFirst = null, newBaseQueueLast = null, update2 = current, didReadFromEntangledAsyncAction$54 = false;
      do {
...
function withReactContent(ParentSwal) {
  ...
  function render2(swal, reactParams) {
...
function showCustomAlert(message, options = {}) {
  return MySwal.fire({
    title: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: message }),
    confirmButtonText: "ok",
    ...options
  });
}
...
async function JoinExistingGame(playerName, setState, PinInput, animalEmoji, setPin, socketGuid, setPlayerGuid) {
  try {
...
function generateAnimalName(adjectives2, animalNames2) {
  return adjectives2[Math.floor(Math.random() * adjectives2.length)] + " " + animalNames2[Math.floor(Math.random() * animalNames2.length)];
}
function pickRandomEmoji() {
  const randomIndex = Math.floor(Math.random() * animalEmojis.length);
  return animalEmojis[randomIndex];
}
function PlayerList({ setState, pin, gameRound }) {
  const [players, setPlayers] = reactExports.useState([]);
  const [showLoading2, setShowLoading] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gameBody roomCode", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "playerList", children: players.map((player) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "player", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: player.emoji
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "playerName", children: [
        player.name,
        " "
      ] })
    ] }, player.guid)) })
...
async function fetchPlayerList(pin, setPlayers) {
  try {
    ...
    console.error("Error fetching player list:", error2);
  }
}
...
function Question({ setState, playerGuid, gameRound }) {
  ...
  const [numberOfPlayers, setNumberOfPlayers] = reactExports.useState(0);
  const [currentReadyPlayers, setCurrentReadyPlayers] = reactExports.useState(0);
  const [foxMessage, setFoxMessage] = reactExports.useState(null);
  const [isFoxEntityAvailable, setIsFoxEntityAvailable] = reactExports.useState(false);
  const [pauseReady, setPauseReady] = reactExports.useState(false);
  const [cheaterPlayers, setCheaterPlayers] = reactExports.useState([]);
  const [isCheater, setIsCheater] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gameBody question-body", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "answer-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            className: "answer",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: `action-btn question-btn ${isReady ? "ready" : "not-ready"}`,
            onClick: () => playerReady(isReady, setIsReady, answer),
            disabled: pauseReady,
            children: pauseReady ? "🦊" : isReady ? "Not Ready" : "I'm Ready"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ready-players", children: [
          currentReadyPlayers,
          "/",
          numberOfPlayers
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cheat-container", children: isFoxEntityAvailable && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    isCheater && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gameBody cheater-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cheater-message", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "🦊 Good luck babe~ " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cheater-message-player-list", children: cheaterPlayers.map((player, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gameBody cheater-message-player", children: [
        player.Emoji,
        " ",
        player.Name,
        ': "',
...
async function initPlayerReadyness(playerGuid, setCurrentReadyPlayers, setNumberOfPlayers) {
...
function Vote({ setState, playerGuid, gameRound }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gameBody vote-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vote-instruction", children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Collating votes..." }) }),
      "Most of you were asked:",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vote-question", children: [
        '"',
        mostAskedQuestion,
        '"'
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "vote-list", children: players.map((player) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vote-player-score", children: [
            "Score: ",
            player.score
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "was-voted-by", children: players.filter((voter) => voter.votedForGuid === player.guid).map((voter) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "was-voted-by-emoji", children: voter.emoji }, voter.guid)) })
        ]
      },
      player.guid
    )) }),
...
function Score({ setState, playerGuid, gameRound, setGameRound }) {
  const [players, setPlayers] = reactExports.useState([]);
  const [enableStartNewRound, setEnableStartNewRound] = reactExports.useState(true);
  reactExports.useEffect(() => {
    ...
    socket2.onmessage = (event) => {
      try {
        ...
        if (message.action === "gameStarted") {
          setGameRound((gameRound2) => gameRound2 + 1);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gameBody score-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "socre-title", children: "Current score board:" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "score-list", children: players.map((player, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "score-player", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "score-player-emoji", children: player.emoji }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "score-player-name", children: player.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `score-player-score ${index === 0 && player.score > 0 ? "score-player-score-winner" : ""}`,
          children: player.score
        }
      )
    ] }, player.guid)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "score-options", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      enableStartNewRound ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "new-round-button", onClick: () => NextRound(), children: "Another round" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Starting new round..." })
    ] })
  ] }) });
}
...
function App() {
  const [state, setState] = reactExports.useState(phases.JoinGame);
  const [playerName, setPlayerName] = reactExports.useState("");
  const [playerGuid, setPlayerGuid] = reactExports.useState("");
  const [pin, setPin] = reactExports.useState("");
  const [gameRound, setGameRound] = reactExports.useState(0);
  const [socketGuid, setSocketGuid] = reactExports.useState("");
  reactExports.useEffect(() => {
    pickBackgroundColor();
    const socket2 = getWebSocket();
    socket2.onmessage = (event) => {
